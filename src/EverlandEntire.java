...
public class EverlandEntire {
	public static int todayYear, todayDate, birthYear, birthMonth, birthDay, birthDate, putDate, Prior, manAge;
	public static int Count = 0, Price = 0, addOrder = 0;
	public static String ticketType, registNumber, age = null, b = "";
	...
	public static void choosePrior() {
		while(true) {
